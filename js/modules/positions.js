      ...
      <div class="detail-panel">
        ...
        <div class="detail-panel-body">
          ...
          <div class="metric-grid">
            ...
            <div class="metric-item"><div class="metric-label">True RPT</div><div class="metric-value">₹${calc.formatNumber(m.trueRPT)}${m.trueRPT > m.initialRPT ? `<span style="display:block;font-size:10px;font-weight:400;color:var(--text-muted);margin-top:2px">Orig: ₹${calc.formatNumber(m.initialRPT)}</span>` : ''}</div></div>
